...
These files are historical planning, rollout, and contract notes from earlier
repository iterations. They are retained for project-evolution context, but the
current public documentation lives in [`../../docs/`](../../docs/).
